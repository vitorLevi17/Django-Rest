...
class EstudantesTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        # )
        self.estudante_01 = Estudantes.objects.get(pk=20)
        self.estudante_02 = Estudantes.objects.get(pk=31)
    ...
    def test_ReqDeleteEstudante(self):
        ...
        response = self.client.delete(f'{self.url}/23') #outra forma de pegar a rota
